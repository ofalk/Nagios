...
# Search multiple paths for check_md5_by_ssh.yml
my @config_paths = (
    File::Spec->catfile((File::Spec->splitpath(File::Spec->rel2abs($0)))[1], 'check_md5_by_ssh.yml'),
    '/omd/sites/prod/etc/check_md5_by_ssh.yml',
    '/opt/monitoring-configs/check_md5_by_ssh.yml',
    '/etc/check_md5_by_ssh.yml',
);
