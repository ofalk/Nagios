...
warn $TrafficIn;
			...
			print "$interface up: $AliasCleaned, LastChanges: $LastChangeCleaned, Traffic in : $TrafficInCleaned octets, out: $TrafficOutCleaned octets | InOctets=$TrafficInCleaned octets ;; OutOctets=$TrafficOutCleaned\n";
			exit $OK;		
